      ...
      <div className="py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2">
            <p className="text-lg font-bold text-foreground">CVLens</p>
          ...
          {/* Legal */}
          <div>
            <h3 className="mb-3 text-sm font-medium text-foreground">Legal</h3>
            <nav>
              {legalLinks.map((link) => (
                <a
                  key={link.label}
        ...
        <div className="mt-8 flex items-center justify-between border-t pt-8">
          <p className="text-sm text-muted-foreground">
            &copy; 2026 CVLens. Built as a capstone project.
          </p>
